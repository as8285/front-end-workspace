...
- multiple : 속성을 통해 파일을 다중으로 선택 할 수 있다.
...
8. **reset** : form 태그내에서 입력한 값을 모두 초기화한다.
...
- 모바일 기기의 경우 키보드 배열이 전화번호를 입력 받을수 있도록 바뀐다.
...
- 페이지 링크,내부 링크가 있는 섹션 영역 마크업 시 사용
...
- 메인메뉴(대메뉴)에포함된 하위메뉴(소메뉴)의 집합

## section

- 단락,이미지,제목 등의 콘텐츠를 묶어 큰 논리적 단위 형성
...
- 본문 내용에 대한 추가적인 설명, 부수적인 콘텍츠 표시에 사용하는 태그
